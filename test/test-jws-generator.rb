...
class JWSGeneratorTest < Test::Unit::TestCase
  def test_trivial_generation
    [
     # ["wisoky.co", { data: [{ x: 1 }, { y: 2 }, { z: 3 }] }, %({"protected":"eyJhbGciOiJFUzI1NiJ9","header":{"kid":"wisoky.co"},"signature":"ORpQDfsuQ3revUzGubqiCUJhuift_g-kiWqZs2CoAaSLJQQ2kOTWeAS28V33nCq-LQRd76-4T7Hmedz_eSRKuw"})],
     ...
     # ["hoegerrenner.info", { data: [{ x: 1 }, { y: 2 }, { z: 3 }] }, %({"protected":"eyJhbGciOiJFUzM4NCJ9","header":{"kid":"hoegerrenner.info"},"signature":"qD-Nupp6EY_sGawnkZIZq7kTLBYCAgArdawsSdxpIVnfYpEP7E5fBZ2afk-sgrUdg56Nz9x2Y2f6O-vP22d7hPjVLJyAO1vHL5ek0xfNqaNG__vqHRx0rfFaC2GzYGsD"})],
